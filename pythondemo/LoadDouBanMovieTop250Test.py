...
wb = Workbook()
save_filename = 'movieinfo_top250.xlsx'
ws1 = wb.active
...
def get_li_content(doc):
    ...
    for i in ol.find_all('li'):
        ...
        if info:  # 是否有短评
            ...
            info_list.append('无短评')
        score.append(lever_star)
...
def main():
    ...
    while url:
        ...
        movie, star, level_num, info_list, url = get_li_content(doc)
        name = name + movie
